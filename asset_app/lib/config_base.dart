...
class Config {
  ...
  // asset
  static String currentAssetSave = 'currenAsset';
  ...
  static String loadingFail = 'Loading fail';
  static String loadingFailBody = 'Loading fail, try log in after seconds';
  static String failLogin = 'Login fail';
  ...
  static String addBuildingMessage = 'Add building';
